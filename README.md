# Deep Learning ECG Arrhythmia Classifier (Educational Case Study)

**Self-initiated pilot to transition from theoretical knowledge to hands-on application of Deep Learning in cardiology.**
